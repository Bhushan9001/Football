...
function TotalGoalsCard({ goalsData }) {
  const data = [
    {
      scored: goalsData.teams.home.league.goals.for.total.total,
      team: goalsData.teams.home.name,
      conceded: goalsData.teams.home.league.goals.against.total.total,
    },
    {
      scored: goalsData.teams.away.league.goals.for.total.total,
      team: goalsData.teams.away.name,
      conceded: goalsData.teams.away.league.goals.against.total.total,
    },
  ];
  return (
